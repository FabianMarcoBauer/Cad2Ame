...
public class Cad2AmePipingTrafo extends SynchronizationHelper{

   public Cad2AmePipingTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        Cad2AmePipingTrafo helper = new Cad2AmePipingTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new Cad2AmePipingTrafo();
