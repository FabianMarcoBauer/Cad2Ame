...
public class XMIProvider {
	...
	public static void main(String[] args) throws IOException {
		...
		Resource s = resourceSet.getResource(
		    URI.createURI("platform:/resource/org.emoflon.ame/instances/HydraulicExcavator.py"), true);
		AMEModel model = (AMEModel) s.getContents().get(0);
		
		Resource xmiResource = new XMIResourceImpl(URI.createFileURI("instances/AMEmodel.xmi"));
